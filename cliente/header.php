...
<html lang="en">
	<head>
        ...
        <meta name="description" content="Tienda de Electronica y Tecnología, Mbyte Soluciones Tecnológicas">
		<meta name="keywords" content="Tecnología, Mbyte, Mbyte Soluciones, Byte soluciones, Tienda de Electrónica, laptops Ecuador, Pc´s gamer,celulares, Tienda de Tecnología"/>	
	...
	<script src="../admin/consumo/verificarInicioSesion.js"></script>
			...
			<div id="top-header">
				<div class="container">
					<ul class="header-links pull-left">
						...
						<li><a href="https://maps.app.goo.gl/GzmEDhJGsxJxzT8x6" target="_blank"><i class="fa fa-map-marker"></i>Quito, Rosa Campuzano y Camilo Guachamín</a></li>
					</ul>
					<ul class="header-links pull-right">
												
							<div class="dropdown">
							  <button class="dropbtn" id="nombrePerfil"> Tu Cuenta <i class="fa fa-user"></i></button>
...
<div id="responsive-nav">
    <!-- NAV -->
    <ul class="main-nav nav navbar-nav" id="categoriasCliente">
        <li id="index" ><a href="index.php">Inicio</a></li>
        <li id="carrito" >
            <a href="carrito.php">
                Mi carrito
                <i class="fa fa-shopping-cart"></i>
                <span id="numeroCarrito" class="carrito-indicador">0</span>
            </a>
        </li>
        <li id="compras"><a href="compras.php">Mis Compras<i class="fa fa-shopping-basket"></i></a></li>
    </ul>
    <!-- /NAV -->
</div>
						...
						<div class="col-md clearfix">
							...
							<div class="dropdown">
									...
									<div class="cart-dropdown">
										...
										<div class="cart-btns">
											<a href="registrar.php" style="width:100%; ">Comprar  <i class="fa fa-arrow-circle-right"></i></a>
										</div>
									</div>							
							</div>-->
							<!-- /Cart -->
...
function setCookie(name, value) {
 ...
 // Función para activar la categoría y almacenar el estado en una cookie
            ...
            if (data.categorias && data.categorias.length > 0) {
                ...
                $(".categoria-item").on("click", function () {					
                    var categoriaId = $(this).data("categoria-id");
					    // Activar la categoría y almacenar el estado en una cookie
...
if (currentUrl.endsWith("/")) {
    ...
    // Verifica qué página está abierta y establece la clase "active" en el enlace correspondiente
    if (currentUrl.indexOf("index.php") !== -1) {
		$(".categoria-item").removeClass("active"); // Quita la clase "active" de todos los elementos
        document.getElementById("index").classList.add("active");
    } else if (currentUrl.indexOf("carrito.php") !== -1) {
		$(".categoria-item").removeClass("active"); // Quita la clase "active" de todos los elementos
        document.getElementById("carrito").classList.add("active");
    } else if (currentUrl.indexOf("compras.php") !== -1) {
		$(".categoria-item").removeClass("active"); // Quita la clase "active" de todos los elementos
